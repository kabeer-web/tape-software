...
// Same page every Core brand uses — brand comes from the URL
// (/inventory/core/:brand). Brand list itself is hardcoded in
...
// StockContext) — old Core rows saved by a previous app version may:
